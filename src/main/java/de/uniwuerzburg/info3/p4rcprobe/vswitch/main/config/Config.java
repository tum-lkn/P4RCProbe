...
import de.uniwuerzburg.info3.p4rcprobe.vswitch.graphml.GraphmlParser;
...
/**
 * This is a Meta-Config. It holds the Configuration for the SwitchRunner,
...
public class Config {
    ...
    /**
     * The Southbound Protocol Used
     */
    private String southbound_protocol;
    /**
    ...
    /**
     * The P4Runtime switches address
     */
    private String switches_address;
    /**
     * The Port that the first P4Runtime switch is listening at
     */
    private int switch_port;
    /**
     * The Topology
     */
    private Topology topology;
    /**
     * Configuration for the SwitchRunner
     */
    ...
    private void loadConfig(String configfile) {
        ...
        try {
            ...
            this.southbound_protocol = props.getProperty("config.southbound_protocol", "openflow");
            this.protocol_version = Integer.parseInt(props.getProperty("config.protocol_version", "1"));
            ...
            this.switches_address = props.getProperty("config.switchesAddress", "127.0.0.1");
            this.switch_port = (Integer.parseInt(props.getProperty("config.switchPort", "9090")));
    ...
    private void loadDefaults() {
        this.southbound_protocol = "openflow";
        ...
        this.switches_address = "localhost";
        this.switch_port = 9090;
    ...
    /**
     * Southbound Protocol Used
     *
     * @return used Southbound Protocol
     */
    public String getSouthboundProtocol() {
        return this.southbound_protocol;
    }
     ...
     * Switches Address
     *
     * @return switches IP Address
     */
    public String getP4runtimeSwitchesAddress() {
        return this.switches_address;
    }

    /**
     * Port at which the first P4Runtime is listening
     *
     * @return port of first switch
     */
    public int getFirstP4runtimeSwitchPort() {
    ...
    /**
     * The SwitchRunner Configuration
     *
     * @return the SwitchRunnerConfig
     */
