 ...
 */
package de.uniwuerzburg.info3.p4rcprobe.vswitch.trafficgen.portgen;
...
public class RandomPortGen implements IPortGen {
    ...
    /* (non-Javadoc)
     * @see p4rcprobe.vswitch.trafficgen.portgen.IPortGen#getPort()
     */
    ...
    /* (non-Javadoc)
     * @see p4rcprobe.vswitch.trafficgen.portgen.IPortGen#getPrivilegdedPort()
     */
    @Override
