 ...
 */
package de.uniwuerzburg.info3.p4rcprobe.vswitch.trafficgen.ipgen;
...
public class SerialIPGenerator implements IIpGenerator {
    ...
    /* (non-Javadoc)
     * @see p4rcprobe.vswitch.trafficgen.ipgen.IIpGenerator#getIpVersion()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see p4rcprobe.vswitch.trafficgen.ipgen.IIpGenerator#getIp()
     */
    @Override
    public byte[] getIp() {
